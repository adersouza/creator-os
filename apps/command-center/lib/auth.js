// Same model as ContentForge's local-api-auth: explicit token, or explicit
// insecure-local opt-in restricted to loopback.
...
export function authorizeApiRequest(request, env = process.env) {
