 ...
 */
// biome-ignore lint/suspicious/noExplicitAny: accepts Firestore Timestamp, Date, or string
...
export async function analyzeBestPostingTimes(
  // biome-ignore lint/suspicious/noExplicitAny: posts come from Supabase with variable shape
  posts: any[]
