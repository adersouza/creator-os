...
export const saveExternalPost = async (
	...
	try {
		await apiFetch("/api/inspiration?action=save-external", saveExternalResponseSchema, {
			method: "POST",
			json: { post },
		});
