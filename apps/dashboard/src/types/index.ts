...
export interface ThreadPost {
  ...
  status: PostStatus;
  publishMode?: "auto" | "notify" | undefined;
  likes: number;
  replies: number;
  accountId: string;
  ...
  igAudioId?: string | undefined; // Meta-native Instagram Audio API asset ID for Reels
  brandedContentSponsorIds?: string[] | undefined; // Paid partnership brand partner IG user IDs (max 2)
  isPaidPartnership?: boolean | undefined; // Adds the paid partnership disclosure label at publish time
