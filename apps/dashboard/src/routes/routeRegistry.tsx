...
export const protectedRouteRegistry: readonly ProtectedRouteDefinition[] = [
	...
	},
	{
		...
		breadcrumb: { root: "Analytics", current: "Attribution", rootPath: "/analytics" },
	},
	{
		id: "listening",
		paths: ["/listening"],
	...
	},
	{
		...
		command: {
			id: "nav-calendar",
			label: "Scheduler",
			subtitle: "Posts, cadence, gaps, and reschedules",
			shortcut: "G S",
			category: "Primary",
			route: "calendar",
			icon: CalendarDays,
	...
	},
	{
		...
		mobileMore: { group: "Growth", label: "Links", order: 1 },
		command: {
			id: "nav-links",
			label: "Links",
	...
	},
	{
		...
		nav: { group: "secondary", label: "Automation", icon: Bot, order: 3, path: "/autopilot" },
		mobileMore: { group: "Publishing", label: "Automation", icon: Bot, order: 2 },
		command: {
			id: "act-auto",
			label: "Open Automation",
			subtitle: "Automated publishing controls and status",
			category: "More",
			route: "autopilot",
			icon: Bot,
			order: 9,
		},
		breadcrumb: { root: "Automation", current: "Plan", rootPath: "/autopilot" },
	},
	{
		id: "composer",
		paths: ["/composer"],
