-- ThreadsDashboard Migration v3 (FIXED)
-- Additional tables for Vercel migration
-- Uses TEXT for all IDs to match existing schema
...
-- ============================================
-- COMPETITOR SNAPSHOTS (no foreign key constraint)
-- ============================================
...
-- ============================================
-- COMPETITOR TOP POSTS (no foreign key constraint)
-- ============================================
...
-- ============================================
-- AUTO-POST STATE - Add missing columns
-- ============================================
DO $$
BEGIN
...
-- DONE!
-- ============================================
SELECT 'Migration v3 (fixed) completed successfully!' as status;
