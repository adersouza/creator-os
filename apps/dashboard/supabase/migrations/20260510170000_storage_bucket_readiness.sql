-- Production storage bucket readiness
--
-- The app writes user media to four public-serving buckets:
--   media        - content library uploads
--   post-media   - server-refreshed platform media
--   avatars      - profile images
--   whitelabel   - workspace branding logos
--
-- Buckets are public so direct object URLs can render in the app, but object
-- listing remains user-scoped through storage.objects policies.
