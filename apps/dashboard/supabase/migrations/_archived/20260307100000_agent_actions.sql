...
-- Records every MCP tool call for replay, debugging, and autonomous cycle resumption.
...
CREATE INDEX idx_agent_actions_tool ON agent_actions (user_id, tool_name);

ALTER TABLE agent_actions ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can read own agent actions"
