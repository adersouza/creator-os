...
<required_reading>
@/Users/adercialonedesouza/Projects/ThreadsDashboard/.claude/get-shit-done/references/ui-brand.md
</required_reading>
...
```bash
INIT=$(node "/Users/adercialonedesouza/Projects/ThreadsDashboard/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE_ARG}")
if [[ "$INIT" == @file:* ]]; then INIT=$(cat "${INIT#@file:}"); fi
AGENT_SKILLS_AUDITOR=$(node "/Users/adercialonedesouza/Projects/ThreadsDashboard/.claude/get-shit-done/bin/gsd-tools.cjs" agent-skills gsd-security-auditor 2>/dev/null)
```

Parse: `phase_dir`, `phase_number`, `phase_name`, `phase_slug`, `padded_phase`.

```bash
AUDITOR_MODEL=$(node "/Users/adercialonedesouza/Projects/ThreadsDashboard/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-security-auditor --raw)
SECURITY_CFG=$(node "/Users/adercialonedesouza/Projects/ThreadsDashboard/.claude/get-shit-done/bin/gsd-tools.cjs" config-get workflow.security_enforcement --raw 2>/dev/null || echo "true")
```
...
```
Task(
  prompt="Read /Users/adercialonedesouza/Projects/ThreadsDashboard/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/adercialonedesouza/Projects/ThreadsDashboard/.claude/get-shit-done/templates/SECURITY.md`
...
```bash
node "/Users/adercialonedesouza/Projects/ThreadsDashboard/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs(phase-${PHASE}): add/update security threat verification"
```
