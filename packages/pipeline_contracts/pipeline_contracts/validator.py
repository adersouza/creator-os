...
POST_METRIC_HISTORY_READ_SCHEMA = "post_metric_history_read.v1.schema.json"
...
SCHEMA_NAMES = {
    ...
    "threadsdash_post_metric_history_read": POST_METRIC_HISTORY_READ_SCHEMA,
...
def validate_schema_examples() -> list[dict[str, Any]]:
    validators: dict[str, Callable[[Any], None]] = {
        ...
        "post_metric_history_read.v1.example.json": validate_post_metric_history_read,
