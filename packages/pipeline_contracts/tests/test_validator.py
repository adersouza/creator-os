...
def test_named_validators_accept_examples():
    ...
    validate_post_metric_history_read(load_example("post_metric_history_read"))
...
def test_post_metric_history_read_requires_selected_metric_columns():
    payload = load_example("post_metric_history_read")
