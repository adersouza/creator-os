...
class AccountPlanningRepository:
    def __init__(
        ...
        *,
        ...
        local_export_readiness: Callable[[dict[str, Any], dict[str, Any] | None], dict[str, Any]],
        ...
        self._active_reference_pattern_for_campaign = active_reference_pattern_for_campaign
    ...
    def account_plan(self, campaign_slug: str, *, user_id: str, usage: dict[str, Any] | None = None) -> dict[str, Any]:
        ...
        for asset in self._dashboard(campaign_slug)["rendered"]:
            ...
            for destination in destinations:
                ...
                compatible, mismatch_reason, profile = self._account_compatible_with_model(
                ...
                payload_rows.append({
                    ...
                    "rankingScore": (self._ranking(campaign_slug)["byAsset"].get(asset["id"]) or {}).get("score"),
    ...
    def ranking(self, campaign_slug: str) -> dict[str, Any]:
        campaign = self._campaign_by_slug(campaign_slug)
        rows = []
        for asset in [self._dashboard_rendered_asset(asset) for asset in self._rendered_for_campaign(campaign["id"])]:
    ...
    def dashboard_rendered_asset(self, asset: dict[str, Any]) -> dict[str, Any]:
        ...
        enriched["referencePattern"] = self._active_reference_pattern_for_campaign(asset["campaign_id"])
