...
def register_operations_commands(sub) -> None:
    ...
    learning_policy_status = sub.add_parser("learning-policy-status")
    learning_policy_status.add_argument("--id", required=True)
    learning_policy_authorize = sub.add_parser("learning-policy-authorize")
    learning_policy_authorize.add_argument("--id", required=True)
    learning_policy_authorize.add_argument("--operator", required=True)
    learning_policy_authorize.add_argument("--reason", required=True)
    learning_policy_authorize.add_argument("--recommendation-fingerprint")
    learning_policy_authorize.add_argument("--expires-at")
    learning_policy_rollback = sub.add_parser("learning-policy-rollback")
    learning_policy_rollback.add_argument("--id", required=True)
    learning_policy_rollback.add_argument("--operator", required=True)
    learning_policy_rollback.add_argument("--reason", required=True)
    ...
    identity_evidence = identity_enroll.add_mutually_exclusive_group(required=True)
    identity_evidence.add_argument("--canonical-source-asset-id")
    identity_evidence.add_argument("--provider-identity-evidence")
