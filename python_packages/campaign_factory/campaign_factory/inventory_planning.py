...
class InventoryPlanningRepository:
    ...
    def inventory_factory_audit(
        ...
        *,
        ...
        counts = self.inventory_stage_counts(creator=creator, campaign_slug=campaign_slug)
    ...
    def inventory_slo_enforcement_audit(
        ...
        *,
        ...
        surface_shortfalls: dict[str, int] = {surface: 0 for surface in self._content_surfaces}
    ...
    def inventory_slo_surface_targets(self, minimum_buffer: int) -> dict[str, int]:
        ...
        targets = {surface: int(minimum_buffer * weights[surface]) for surface in self._content_surfaces}
    ...
    def inventory_stage_counts(self, *, creator: str | None = None, campaign_slug: str | None = None) -> dict[str, int]:
        ...
        caption_families = self.inventory_count_related("caption_families", "parent_asset_id", asset_ids)
        caption_versions = self.inventory_count_related("caption_versions", "parent_asset_id", asset_ids)
