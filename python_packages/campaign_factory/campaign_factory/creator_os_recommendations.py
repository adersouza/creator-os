...
class CreatorOSRecommendationRepository:
        ...
        *,
        ...
        for item in report_items:
            ...
            recommendations.append({
                ...
                "recommendedAction": self.creator_os_winner_action(item.get("recommendedAction")),
    ...
    def creator_os_recommended_inventory(self, *, creator: str, limit: int = 5) -> list[dict[str, Any]]:
        ...
        for pattern in analysis.get("bestPerformingPatterns") or []:
            ...
            posting_window = str(pattern.get("key") or "") if dimension == "postingWindow" else self.creator_os_lineage_posting_window(pattern)
