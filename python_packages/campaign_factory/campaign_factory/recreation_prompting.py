...
def _instruction(
    ...
    *,
    ...
    action = (
        ...
        "behavior, setting, and performance energy at full visual specificity. "
        "Describe the framing, camera height, angle and distance; exact pose, body "
        "orientation, arch, hip placement, weight distribution, limbs and hands; "
        "every clothing item, its cut, color, material, neckline, strap placement, "
        "tightness and how it contours the body; visible breast size and fullness, "
        "cleavage depth and shape, waist-to-hip proportions, butt size and roundness, "
        "and every other visible detail that makes the composition attractive; "
        "expression, gaze, setting detail, lighting direction and quality, focus, "
        "grain, motion blur and casual photographic imperfections. Wardrobe and "
        "setting are exact observed specifics, never category labels. In the video "
        "prompts also describe the reference's body and fabric motion: natural "
        "soft-tissue movement of chest and hips through each step, turn, bounce or "
        "lean, how the fabric shifts, stretches and settles against the body, and "
        "hair movement and settling. Ground every detail in the visible reference."
        if has_reference_video
