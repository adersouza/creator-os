...
def _authorization(scope: dict, *, now: datetime, **overrides) -> dict:
    payload = {
        ...
        "governanceContext": {
            ...
            "campaignId": "campaign_stacey",
            "campaignLifecycleVersion": 1,
            "campaignStatus": "production_ready",
            ...
            "authorizationEventIds": ["auth_event_likeness", "auth_event_commercial"],
            "authorizationIds": ["auth_likeness", "auth_commercial"],
            "governanceFingerprint": "b" * 64,
