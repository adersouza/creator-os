    ...
    *,
    ...
    _write_json(
        clip_dir / "_readiness.json",
        {
            ...
            "summary": {"total": 1, "ready": 1, "warn": 0, "not_ready": 0},
            "records": [{"filename": output.name, "status": "ready", "warnings": []}],
        },
    )
