...
class AdvancedRoadmapTests(unittest.TestCase):
    ...
    def test_grok_simple_prompt_documents_only_clean_fields(self):
        ...
        self.assertIn("deliberately casual, believable handheld selfie", prompt)
        self.assertIn("cute fitted everyday clothing", prompt)
        self.assertIn("camera in front of part of the face", prompt)
