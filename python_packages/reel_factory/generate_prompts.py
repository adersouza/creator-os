...
def build_direct_higgsfield_prompt_instruction(creative_direction: str = "", **kwargs) -> str:
    ...
    example_prompt = (
        ...
        "extreme hourglass figure from the reference image. [DESCRIBE HER EXACT POSE, POSTURE, AND SETTING FROM THE IMAGE HERE]. "
    ...
    return (
        ...
        "Requirements:\n"
        "- The image generator cannot see the reference image! You MUST explicitly describe the physical pose, body angle, whether she is sitting or standing, what she is sitting on, hand placement, setting, lighting, and framing.\n"
        ...
        "- You MUST explicitly describe the specific color, cut, and style of clothing she is wearing. Do NOT say 'same as the reference image'. Do not generate naked or nude descriptions.\n"
